            ...
            return (
              ...
              >
                ...
                <div className="w-full flex justify-between items-center">
                  ...
                  <Link
                    href={service.href}
                    className="text-black w-[70px] h-[70px] rounded-full bg-white group-hover:bg-accent transition-all duration-500 flex justify-center items-center hover:-rotate-45"
                  >
